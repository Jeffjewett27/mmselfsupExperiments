...
DISTRIBUTIONS = {
    "learning_rate": LogUniformDistribution(0.0001, 0.03),
    ...
    "warmup_epochs": CategoricalDistribution([0,2,4,6]),
    "loss_lambda": UniformDistribution(0.5,0.65)
}
...
print(df)
df.to_csv('experiment/configs/mediumtrials.csv', index=False)