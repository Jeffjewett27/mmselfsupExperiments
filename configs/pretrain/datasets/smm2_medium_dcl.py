...
data = dict(
    ...
    train=dict(
        ...
        data_source=dict(
            type=data_source,
            data_prefix='data/smm2/youtube_medium/train',
            ann_file='data/smm2/youtube_medium/trainList.txt',
        ),
        num_views=[2],
    ...
    val=dict(
        ...
        data_source=dict(
            type=data_source,
            data_prefix='data/smm2/youtube_medium/validation',
            ann_file='data/smm2/youtube_medium/valList.txt',
        ),
        num_views=[2],
        pipelines=[train_pipeline],
        prefetch=False,
